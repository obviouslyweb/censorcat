![CensorCAT logo](icons\icon-512.png)

# censorcat - *Censor Curation And Text-filtering tool*
Dynamic censoring extension for the Firefox Browser.
...
## Information
CensorCAT is being developed with the usage of Firefox WebExtensionsAPI. This is my first time working on something like this, so feedback and suggestions in issues would be greatly appreciated!
